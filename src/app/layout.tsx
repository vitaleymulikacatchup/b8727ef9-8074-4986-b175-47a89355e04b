...
export const metadata: Metadata = {
  title: "Serenity Hotels - Luxury Accommodations & World-Class Service",
  description: "Experience luxury hospitality at Serenity Hotels. Book your stay in our elegantly designed rooms, enjoy world-class amenities, fine dining, and spa services.",
  keywords: "luxury hotel, accommodations, resort, fine dining, spa, wellness, hospitality",
  metadataBase: new URL("https://serenityhotels.com"),
  alternates: {
    canonical: "https://serenityhotels.com"
  },
  openGraph: {
    title: "Serenity Hotels - Premium Luxury Hotel Experience",
    description: "Discover world-class accommodations and unforgettable service at our premier hotel.",
    type: "website",
    siteName: "Serenity Hotels",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32m5rRdd38TAyU0DZCqvrl288SF/uploaded-1763840395848-iqi507a6.jpg",
  ...
  twitter: {
    ...
    title: "Serenity Hotels - Premium Luxury Hotel Experience",
    description: "Book your luxury stay with world-class amenities and exceptional service.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32m5rRdd38TAyU0DZCqvrl288SF/uploaded-1763840395848-iqi507a6.jpg"]
  },
  robots: {
    index: true,
    follow: true
